    ...
    const handleClick = async (notification) => {
        try {
            ...
            if (notification.action_url) {
                ...
                navigate('/opportunities');
            } else if (notification.type === 'interview_proposed' || notification.action_type === 'interview') {
                navigate('/interviews');
            } else if (notification.type === 'recruiter_activity' || notification.action_type === 'message') {
                navigate('/messages');
            } else if (notification.type === 'application_update') {
                navigate(user?.role === 'recruiter' ? '/recruiter/pipeline' : '/applications');
            }
        } catch (err) {

...
export const mockResumeAnalysis = {
    ...
    executive_summary: "Your resume is already very strong for a 2026 student. Technically it looks like an early-career AI/Backend engineer resume rather than a fresher resume. You are 80-85% there.",
    strengths: [
    ...
    // Parsed fields (flat)
    extracted_skills: ["Python", "FastAPI", "Docker", "Redis", "AWS", "YOLO", "RAG", "LLM", "React"],
    experience: [
        { title: "AI/ML Intern", company: "TechCorp", start_date: "Jan 2025", end_date: "Jun 2025", description: "Built RAG pipelines and inference APIs." },
        { title: "Backend Developer Intern", company: "StartupInc", start_date: "Jul 2024", end_date: "Sep 2024", description: "Dockerized microservices and implemented Redis caching." }
    ],
    education: [
    ...
    ai_enhanced: true,
    message: "Resume parsed with 92.5% confidence"
};
